class PokemonTrainersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pokemon_trainer.save
        ...
        format.html { render '/pokemon_trainers/new', status: :unprocessable_entity }
  ...
  private
    ...
    def pokemon_trainer_params
      params.require(:pokemon_trainer).permit(:nombre, :apellido, :region, :email, :captured_pokemons)
    end
end

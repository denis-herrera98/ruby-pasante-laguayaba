...
class PokemonTrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pokemon_trainer" do
    assert_difference('PokemonTrainer.count') do
      post pokemon_trainers_url, params: { pokemon_trainer: { apellido: @pokemon_trainer.apellido, email: @pokemon_trainer.email, nombre: @pokemon_trainer.nombre, region: @pokemon_trainer.region} }
    end
  ...
  test "should update pokemon_trainer" do
    patch pokemon_trainer_url(@pokemon_trainer), params: { pokemon_trainer: { apellido: @pokemon_trainer.apellido, email: @pokemon_trainer.email, nombre: @pokemon_trainer.nombre, region: @pokemon_trainer.region } }
